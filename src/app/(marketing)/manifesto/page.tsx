...
export default function ManifestoPage() {
  return (
    <div className="min-h-screen bg-aipratika-cream dark:bg-aipratika-purple-dark bg-texture">
      <section className="px-4 md:px-6 lg:px-10 py-8 md:py-16 lg:py-24">
        <div className="container mx-auto max-w-4xl">
          <div className="mb-8 md:mb-12">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6 text-aipratika-purple dark:text-aipratika-cream leading-tight">
              Manifesto di AI Pratika
            </h1>
            <h2 className="text-xl md:text-2xl lg:text-3xl font-semibold text-aipratika-violet mb-4 md:mb-6 leading-tight">
              Non studiare l&apos;AI. Usala.
            </h2>
            <p className="text-base md:text-lg lg:text-xl text-aipratika-purple/80 dark:text-aipratika-cream/80 leading-relaxed">
          ...
          <div className="mb-12 md:mb-16">
            <div className="bg-aipratika-violet/10 p-4 md:p-6 rounded-lg mb-6 md:mb-8">
              <p className="text-aipratika-purple dark:text-aipratika-cream/90 font-medium text-base md:text-lg mb-3 md:mb-4 leading-relaxed">
                <strong>Non ti insegniamo l&apos;AI. La usiamo per risolvere problemi veri.</strong>
              </p>
              <p className="text-aipratika-purple dark:text-aipratika-cream/90 mb-3 md:mb-4 leading-relaxed">
              ...
              <p className="text-aipratika-purple dark:text-aipratika-cream/90 leading-relaxed">
          ...
          <div className="mb-12 md:mb-16">
            <div className="flex items-start gap-3 md:gap-4 mb-4 md:mb-6">
              <div className="p-2 md:p-3 bg-aipratika-violet/10 rounded-full flex-shrink-0 mt-1">
                <Target className="w-5 h-5 md:w-6 md:h-6 text-aipratika-violet" />
              </div>
              <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-aipratika-purple dark:text-aipratika-cream leading-tight">
          ...
          <div className="mb-12 md:mb-16">
            <div className="flex items-start gap-3 md:gap-4 mb-4 md:mb-6">
              <div className="p-2 md:p-3 bg-aipratika-violet/10 rounded-full flex-shrink-0 mt-1">
                <Wrench className="w-5 h-5 md:w-6 md:h-6 text-aipratika-violet" />
              </div>
              <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-aipratika-purple dark:text-aipratika-cream leading-tight">
          ...
          <div className="mb-12 md:mb-16">
            <div className="flex items-start gap-3 md:gap-4 mb-4 md:mb-6">
              <div className="p-2 md:p-3 bg-aipratika-violet/10 rounded-full flex-shrink-0 mt-1">
                <Clock className="w-5 h-5 md:w-6 md:h-6 text-aipratika-violet" />
              </div>
              <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-aipratika-purple dark:text-aipratika-cream leading-tight">
          ...
          <div className="mb-12 md:mb-16">
            <div className="flex items-start gap-3 md:gap-4 mb-4 md:mb-6">
              <div className="p-2 md:p-3 bg-aipratika-violet/10 rounded-full flex-shrink-0 mt-1">
                <CheckCircle className="w-5 h-5 md:w-6 md:h-6 text-aipratika-violet" />
              </div>
              <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-aipratika-purple dark:text-aipratika-cream leading-tight">
          ...
          <div className="mb-12 md:mb-16">
            <div className="flex items-start gap-3 md:gap-4 mb-4 md:mb-6">
              <div className="p-2 md:p-3 bg-aipratika-violet/10 rounded-full flex-shrink-0 mt-1">
                <Compass className="w-5 h-5 md:w-6 md:h-6 text-aipratika-violet" />
              </div>
              <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-aipratika-purple dark:text-aipratika-cream leading-tight">
          ...
          <div className="mb-12 md:mb-16">
            <div className="flex items-start gap-3 md:gap-4 mb-4 md:mb-6">
              <div className="p-2 md:p-3 bg-aipratika-violet/10 rounded-full flex-shrink-0 mt-1">
                <Users className="w-5 h-5 md:w-6 md:h-6 text-aipratika-violet" />
              </div>
              <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-aipratika-purple dark:text-aipratika-cream leading-tight">
                Il nostro modo di lavorare
              </h2>
          ...
          <div className="mb-12 md:mb-16">
            <div className="flex items-start gap-3 md:gap-4 mb-4 md:mb-6">
              <div className="p-2 md:p-3 bg-aipratika-violet/10 rounded-full flex-shrink-0 mt-1">
                <Lightbulb className="w-5 h-5 md:w-6 md:h-6 text-aipratika-violet" />
              </div>
              <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-aipratika-purple dark:text-aipratika-cream leading-tight">
                A chi ci rivolgiamo
              </h2>
            </div>
            <div className="space-y-3 md:space-y-4 text-aipratika-purple dark:text-aipratika-cream/90 leading-relaxed">
              <p>
            ...
            <p className="text-aipratika-purple dark:text-aipratika-cream/90 mt-4 md:mt-6 leading-relaxed">
          ...
          <div className="mb-12 md:mb-16">
            ...
            <ul className="text-aipratika-purple dark:text-aipratika-cream/90 space-y-2 md:space-y-3 leading-relaxed">
          ...
          <div className="mb-12 md:mb-16">
            <div className="flex items-start gap-3 md:gap-4 mb-4 md:mb-6">
              <div className="p-2 md:p-3 bg-aipratika-violet/10 rounded-full flex-shrink-0 mt-1">
                <Mail className="w-5 h-5 md:w-6 md:h-6 text-aipratika-violet" />
              </div>
              <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-aipratika-purple dark:text-aipratika-cream leading-tight">
                Inizia da qui
              </h2>
            ...
            <p className="text-aipratika-purple dark:text-aipratika-cream/90 mb-6 md:mb-8 leading-relaxed">
