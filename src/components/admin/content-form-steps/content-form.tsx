...
export function ContentForm()  {
    ...
    const canProceed = contentType && jsonData
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent className="w-full sm:w-[600px] sm:max-w-[600px] flex flex-col p-0">
          ...
          <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 sm:py-6">
            ...
            {step === 2 && <StepTwo categories={categories} setCategories={setCategories} />}
            {step === 3 && <StepThree status={status} setStatus={setStatus} />}
          </div>
  
          <div className="flex items-center justify-between border-t px-4 sm:px-6 py-3 sm:py-4">
